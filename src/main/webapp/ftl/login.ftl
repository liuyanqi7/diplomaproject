...
<DIV id=regLogin class=wrap>
    <DIV class=dialog>
        <DIV class=box>
            <H4>用户登录</H4>
            <FORM id=user method=post name=user action="/user/userLogin">
                <DIV class=infos>
                    <TABLE class=field>
                        <TBODY>
                        <TR>
                        ...
                        <TR>
                            ...
                            <TD><!-- <input type="text" class="text" name="name" /> --><INPUT
                                        id=user_name class=text type=text name=userName>${msg} </TD></TR>
                        <TR>
                            <TD class=field>密　　码：</TD>
                            <TD><!-- <input type="password" class="text" name="password" /> --><INPUT
                                        id=user_password class=text type=password name=userPass> </TD></TR><!--
						<tr>
